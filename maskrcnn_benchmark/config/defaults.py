...
_C.MODEL.STN_HIDDEN_DIM = 256
_C.MODEL.IS_PRETRAIN = True
_C.MODEL.PRETRAIN_ON = True
...
_C.INPUT.USE_UNBIAS_SAMPLING = True
_C.INPUT.USE_REL_AUG = True
_C.INPUT.USE_STN = True
# -----------------------------------------------------------------------------
# Dataset
# -----------------------------------------------------------------------------
_C.DATASETS = CN()
...
_C.MODEL.ROI_RELATION_HEAD.ADJ_PATH=""
_C.MODEL.ROI_RELATION_HEAD.THRESH = 0.01
...
_C.SOLVER.UPDATE_SCHEDULE_DURING_LOAD = True
