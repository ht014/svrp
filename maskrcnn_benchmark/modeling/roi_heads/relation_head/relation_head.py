...
class ROIRelationHead(torch.nn.Module):
    ...
    def forward(self, features, proposals, targets=None, logger=None):
        ...
        # refine_logits, relation_logits, add_losses = self.predictor(features, proposals, rel_pair_idxs, rel_labels, rel_binarys,
        #                                                             union_features, logger)
        refine_logits, relation_logits, add_losses = self.predictor(proposals, rel_pair_idxs, rel_labels, rel_binarys, roi_features, union_features, logger=None)
        # for test
