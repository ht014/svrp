...
from .soft_vis_rel_prompt import SVRP
from .pretrain_transformer import TransformerContext as PreTransformer
from .utils_motifs import to_onehot

@registry.ROI_RELATION_PREDICTOR.register("PromptPredictor")
class PromptPredictor(nn.Module):
    def __init__(self, config, in_channels):
        super(PromptPredictor, self).__init__()
        ...
        # module construct
        self.context_layer = SVRP(config, 256)
    ...
    def forward(self, features,proposals, rel_pair_idxs, rel_labels, rel_binarys,  union_data, logger=None):
        ...
        cls_outputs = self.context_layer(features, proposals, rel_pair_idxs)
        ...
        rel_dists = self.rel_classifier(cls_outputs)
...
class TransformerPredictor(nn.Module):
    ...
    def forward(self, proposals, rel_pair_idxs, rel_labels, rel_binarys, roi_features, union_features, logger=None):
        ...
        rel_dists = self.ctx_compress(prod_rep) * 1
