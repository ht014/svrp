...
def train(cfg, local_rank, distributed, logger):
    ...
    if cfg.MODEL.PRETRAIN_ON:
        eval_modules = (model.rpn, model.backbone, model.roi_heads.box,
                        #model.roi_heads.relation.predictor.context_layer,
                        #model.roi_heads.relation.box_feature_extractor,
                        #model.roi_heads.relation.union_feature_extractor.feature_extractor
                        )
    else:
        eval_modules = (model.rpn, model.backbone, model.roi_heads.box,
                         model.roi_heads.relation.predictor.context_layer.box_feature_extractor,
                        model.roi_heads.relation.predictor.context_layer.context_layer,
                        model.roi_heads.relation.predictor.context_layer.text_transformer
                        )

        fix_eval_modules(eval_modules)

    # NOTE, we slow down the LR of the layers start with the names in slow_head
    slow_heads = []
    ...
    if cfg.MODEL.PRETRAIN_ON:
        ...
        load_mapping = {"roi_heads.relation.predictor.context_layer.box_feature_extractor" : "roi_heads.pretrain.box_feature_extractor",
                         "roi_heads.relation.predictor.context_layer.context_layer" : "roi_heads.pretrain.context_layer",
                         "roi_heads.relation.predictor.context_layer.text_transformer": "roi_heads.pretrain.text_transformer",
                         }
